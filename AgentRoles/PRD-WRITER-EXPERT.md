...
- **追溯矩阵**：`/qa plan` 或大模型会根据 `docs/data/templates/TRACEABILITY-MATRIX-TMPLATE.md` 动态生成 `/docs/data/traceability-matrix.md`，持续更新 `Story → AC → Test Case ID` 映射，供 QA/TASK/ARCH 共用。
