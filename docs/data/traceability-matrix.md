...
| US-ENVINIT-001 | 首次创建六个环境文件 | AC-ENVINIT-001-01 | TC-ENVINIT-001 | 📝 待启动 | @qa | 三组 example/实际文件配对初始化 |
| US-ENVINIT-001 | Git 所有权边界 | AC-ENVINIT-001-02 | TC-ENVINIT-002 | 📝 待启动 | @qa | example 可跟踪、实际文件被忽略 |
| US-ENVINIT-002 | 已有文件保护 | AC-ENVINIT-002-01 | TC-ENVINIT-003 | 📝 待启动 | @qa | 后续 apply 不修改已有内容 |
| US-ENVINIT-003 | Dry-run 无副作用 | AC-ENVINIT-003-01 | TC-ENVINIT-004 | 📝 待启动 | @qa | 只报告缺失文件，不写盘 |
