...
**检查项**：
- ✅ 主 PRD 必需章节完整性（检测 1~9 节与模块导航）
- ✅ 强制存在 `docs/prd-modules/module-list.md` 和至少一个模块 PRD
- ✅ 模块 PRD 符合 `docs/prd-modules/MODULE-TEMPLATE.md` 中的结构
- ✅ 追溯矩阵是否存在
- ✅ 依赖关系图是否存在
...
> 📌 `check-completeness.js` 只接受模块化结构：主 PRD 总纲、模块清单、至少一个模块 PRD 和追溯资料缺一不可。
